...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// OnClickListener listener42 = new b42_ClickListener();
		// OnClickListener listener43 = new b43_ClickListener();
		...
		// button_table[42].setOnClickListener(listener);
		// button_table[43].setOnClickListener(listener);
	...
	void Click(int a) {
		if (button_table[a].getText().equals("")) {
			...
			bean.date(year, month + 1,Integer.parseInt(button_table[a].getText().toString()));
			Intent intent = new Intent(MainActivity.this, ListActivity.class);
			intent.putExtra("date", year + "/" + (month + 1) + "/" + Integer.parseInt(button_table[a].getText().toString()));
